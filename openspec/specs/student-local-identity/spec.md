...
| Audience | Effect |
|----------|--------|
| Alumno | No visible change; current profile-scoped progress and blocked no-profile behavior remain stable. Active profile lookup is now centralized behind a single boundary. |
