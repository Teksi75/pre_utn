...
> correction, and the audit-finding corrective batch on top of it.
> The static-retirement segment is preserved verbatim so the
> cross-cutting U3 evidence and the foreign-authority blocker remain
> auditable. The reduced FocusSelector presentation layer is
> described in the first addendum; the audit-finding fixes (live
> readiness/map recompute + dead empty-state branch removal) are
> described in the second addendum below.

---

## Addendum — Audit-finding corrective batch (this run)
